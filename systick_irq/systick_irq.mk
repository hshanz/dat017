...
ProjectPath            :=C:/Users/Jogus/Documents/Studier/Programing/Moppen/Labborationer/WorkBook/systick_irq
...
PostBuild:
	...
	arm-none-eabi-objdump -D -S ./Debug/systick_irq.elf > ./Debug/systick_irq.dass
	@echo Done
...
$(IntermediateDirectory)/systick_irq.c$(ObjectSuffix): systick_irq.c $(IntermediateDirectory)/systick_irq.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Jogus/Documents/Studier/Programing/Moppen/Labborationer/WorkBook/systick_irq/systick_irq.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/systick_irq.c$(ObjectSuffix) $(IncludePath)
